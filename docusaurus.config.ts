...
const config: Config = {
  ...
  organizationName: "umersaleem90", // Usually your GitHub org/user name.
    ...
    [
      "classic",
      {
        docs: {
          ...
          editUrl: "https://github.com/umersaleem90/merit-api-docs/tree/main/",
        },
        blog: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: "https://github.com/umersaleem90/merit-api-docs",
          label: "GitHub",
          position: "right",
        },
      ],
